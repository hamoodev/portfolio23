    ...
    <section className="bg-primary text-white min-h-screen flex items-center justify-center">
      ...
      <div className="flex flex-col flex-1 gap-5 max-w-xs md:max-w-3xl">
        ...
        <div className="flex flex-row">
          <a
            href="#projects"
            className=" text-center border-2 border-accent hover:border-2 text-accent hover:border-accent w-52 rounded-sm p-1  font-medium hover:bg-accent text-lg hover:text-black duration-200"
          >
          ...
          <a
            href="/resume.pdf"
            className="ml-2 text-center border-2 border-accent hover:border-2 text-accent hover:border-accent w-52 rounded-sm p-1  font-medium hover:bg-accent text-lg hover:text-black duration-200"
          >
            <HackerText defaultText="Resume" speed={30} />
          </a>
        </div>
      </div>
    </section>
